			...
			<table class="table">
				...
				<tbody>
	 				<c:forEach items="${command}" var="tarea" >					
					  <tr>
					    <td>${tarea.id}</td>
					    <td><a data-toggle="tooltip" title="Editar tarea" href="editarTareaProyecto?id=<c:out value="${tarea.id}"/>"><c:out value=""/><span class="glyphicon glyphicon-pencil"></span></a></td>						    
					    <td><a data-toggle="tooltip" title="Eliminar tarea" href="eliminarTareaProyecto?id=<c:out value="${tarea.id}"/>"><c:out value=""/><span class="glyphicon glyphicon-remove"></span></a></td>						    					    					    
					    ...
					    <td>
							...
							<c:choose>
							    <c:when test="${tarea.estado != 'No iniciada'}">
					    			<div><a data-toggle="tooltip" title="Retroceder estado" href="cambiarEstadoAtrasProyecto?idTarea=<c:out value="${tarea.id}"/>"><span class="glyphicon glyphicon-arrow-left"></span></a></div>
							    </c:when>    
							    <c:otherwise>
					    	...
					    	<div><a data-toggle="tooltip" title="Avanzar estado" href="cambiarEstadoAdelanteProyecto?idTarea=<c:out value="${tarea.id}"/>"><span class="glyphicon glyphicon-arrow-right"></span></a></div>					    	
							    </c:when>    
							    <c:otherwise>
