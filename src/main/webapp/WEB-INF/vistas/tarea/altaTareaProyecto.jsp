	...
	<nav class="navbar navbar-fixed-top menu">
		...
		<div class = "container">
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">		
				<form:form action="agregarTareaProyecto" method="POST" modelAttribute="tarea" role="form">      
					...
					<div class="form-group">
						...
						<label><form:radiobutton path="estado" value="En curso" disabled="true"/></label>  
						<label><h5> En curso</h5></label>      						   						    
						<label><form:radiobutton path="estado" value="Finalizada" disabled="true"/></label>
